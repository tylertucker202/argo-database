...
case $HOSTNAME in
  (carby) 
                /home/tyler/anaconda3/envs/argo/bin/python process_queue.py --logName process_queue --npes 1
		;;
  (kadavu.ucsd.edu) 
		python3.6 process_queue.py --logName process_queue --npes 1
		;;
  (*)
		python process_queue.py --logName process_queue --npes 1
		;;
esac
